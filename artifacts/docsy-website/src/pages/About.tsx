...
const reasons: Reason[] = [
  ...
  { icon: Package, title: "Docsy Safe+ Support", when: "If you can't access your vault, a file is missing, you need to add or remove a user, or you have questions about your plan or trial.", include: "The email address on your account and a description of the issue. Include the appointment date if a specific file is missing.", method: "email", urgent: false },
