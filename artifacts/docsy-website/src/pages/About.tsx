...
const reasons: Reason[] = [
  ...
  { icon: MessageSquare, title: "Missing or Delayed Deliverable", when: "If you haven't received your notarized document, apostille certificate, transcript, or Safe+ upload within the expected timeframe.", include: "Your appointment date, service type, and where you expected the deliverable (email, physical mail, or Safe+ vault). We'll track it down.", method: "email", urgent: false },
