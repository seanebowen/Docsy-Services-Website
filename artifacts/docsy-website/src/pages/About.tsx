...
const reasons: Reason[] = [
  ...
  { icon: MessageSquare, title: "Missing or Delayed Deliverable", when: "If you haven't received your notarized document, apostille certificate, transcript, or Safe+ Vault upload within the expected timeframe.", include: "Your appointment date, service type, and where you expected the deliverable (email, physical mail, or Safe+ Vault vault). We'll track it down.", method: "email", urgent: false },
  ...
  { icon: Package, title: "Docsy Safe+ Vault Support", when: "If you can't access your vault, a file is missing, you need to add or remove a user, or you have questions about your plan or trial.", include: "The email address on your account and a description of the issue. Include the appointment date if a specific file is missing.", method: "email", urgent: false },
        ...
        <div className="max-w-5xl mx-auto mt-10 grid grid-cols-1 sm:grid-cols-2 gap-px" style={{ backgroundColor: DIV }}>
          ...
          <FadeIn delay={60} threshold={0.05}>
            <div className="px-8 py-10" style={{ backgroundColor: BG }}>
              ...
              <p className="text-sm text-white/45 leading-relaxed">
                Use for billing questions, invoice disputes, missing deliverables, corporate account inquiries, Safe+ Vault vault support, and anything where you need a written record. Response within 4 business hours.
              </p>
            </div>
          </FadeIn>
        </div>
