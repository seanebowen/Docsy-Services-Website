...
const faqs = [
  {
    category: "General",
    items: [
      { q: "How much does a notary cost?", a: "It depends on the service. RON starts at $25 for the first notarization. Mobile notary visits start at $30 travel + the statutory notary fee ($10 for the first signature under Texas law). Apostilles start at $150 all-inclusive. Loan signings start at $125 for a seller package. You know your exact price before you confirm — always. Nothing starts until the number is agreed on." },
      ...
      { q: "Are you available on weekends and after hours?", a: "Yes. Docsy is available 7 days a week from early morning to midnight. After-hours appointments (9 PM–midnight) carry a +$20 surcharge, always disclosed at booking. Docsy+ members are exempt. Same-hour RON is available when you need it done right now." },
