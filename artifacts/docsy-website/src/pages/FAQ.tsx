...
const faqs = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What's included in the transcript?", a: "The $8.50/page Standard rate includes: word index, certified PDF, and e-transcript ASCII file. PDF-only delivery is always free. These are standard inclusions — not add-ons. No hidden fees for files that agencies typically charge extra for." },
      ...
      { q: "What are the payment terms for electronic reporting?", a: "All electronic reporting orders — appearance-only and transcript orders — are NET-14. Transcript orders require a 50% deposit at scheduling. The remaining balance is due within 14 days of completion. Corporate accounts with NET-30 terms are available upon request." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What's the difference between Docsy+ and Docsy Safe+?", a: "Docsy+ is a service membership with perks — priority access, free notarizations, after-hours access. Docsy Safe+ is a document storage subscription — an encrypted vault that stores every deliverable from every Docsy appointment automatically. They are separate products. You can have one, both, or neither." },
      { q: "Can I stack my Docsy+ discount with other promotions?", a: "Yes. Docsy+ discounts stack with time-window promotions (Night Shift Seal, Midday Mile, Early Bird), HonorPass, and most other active promotions. Stacking rules are listed on the Promotions page — no asterisks, no surprises." },
...
const guides = [
  ...
  { id: "docsy-safe-plus", icon: ScanLine, title: "How Docsy Safe+ Works", summary: "Encrypted storage for all Docsy appointment deliverables.",
    content: [
      { heading: "What it is", body: "Docsy Safe+ is an encrypted file vault that automatically stores every deliverable from every Docsy appointment. No uploading required. Every RON notarization, every apostille, every loan signing, every electronic reporting session — transcripts included — stored automatically." },
      { heading: "Free trial", body: "Docsy Safe+ starts automatically with your first service — no signup, no credit card required, unless you opt out. 30 days free. After 30 days, continue from $5/month or stop — no automatic charge." },
      { heading: "Access", body: "Access your vault from any device, any time. Download or share documents and transcripts directly from your vault. Grant family members access (Family plan)." },
      { heading: "Plans", body: "Free (up to 5 files, 30-day trial), Personal $5/month (up to 50 files), Family $15/month (up to 150 files, 4 users), Professional $25/month (up to 500 files), Business/Enterprise (custom pricing, contact Docsy)." },
    ],
  },
  ...
  { id: "safe-plus-trial-faq", icon: Package, title: "Docsy Safe+ Trial — What You Need to Know", summary: "Exactly how the 30-day trial works.",
    content: [
  ...
  { id: "billing-and-payments", icon: Receipt, title: "Billing & Payment Methods", summary: "Every payment option and when it applies.",
    content: [
      ...
      { heading: "When is payment due?", body: "For most services: at or immediately after completion. Electronic reporting (all orders): NET-14. Corporate accounts: NET-30 available upon request." },
