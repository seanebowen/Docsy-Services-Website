...
const guides = [
  ...
  { id: "court-reporting-how-it-works", icon: FileText, title: "How Docsy Electronic Reporting Works", summary: "For attorneys and legal teams — from booking to transcript delivery.",
    content: [
      ...
      { heading: "Transcript delivery", body: "Standard (10-business-day) transcripts are $8.50/page. Rough Draft is $0.75/page, Extended is $7.50/page, Rush is $12.00/page, certified copies are $2.50/page. Word index, certified PDF, PDF delivery, and e-transcript are always included on certified orders — no separate line items. Transcripts are delivered via secure portal once payment is complete." },
