...
const faqs: { category: string; items: FaqItem[] }[] = [
  {
    ...
    items: [
      ...
      { q: "Are you available on weekends and after hours?", a: (<>Standard hours are 9 AM – 9 PM, 7 days a week, for every individual customer (members and non-members alike). Time-window promotions apply on weekdays automatically: Night Shift Seal (6–9 PM, $10 off <GLink slug="ron">RON</GLink>) and Midday Miles (12–4 PM, $10 off mobile notary). Weekend Warrior applies on Saturdays and Sundays for loan signing appointments (20% off). For 24/7 RON, mobile signings until midnight, and a dedicated after-hours line, see <Link href="/business" className="underline">Docsy Business+ Firm accounts</Link>.</>) },
  ...
  {
    category: "Docsy Business+",
    items: [
      { q: "What is Docsy Business+?", a: (<>Docsy Business+ is a single tiered subscription that covers both individuals and firms. Solo ($15/mo), Pro ($30/mo), and Elite ($49/mo) are individual memberships with discounts, free monthly notarizations, and priority booking. Firm (custom-quoted) is the B2B tier for title companies, law firms, lenders, and corporate legal teams — with bulk-booking, NET 30 invoicing, multi-user rosters, and extended priority hours. <Link href="/business" className="underline">See all four tiers →</Link></>) },
      { q: "What's the difference between Business+ and Docsy Safe+?", a: "Docsy Business+ is the membership/firm-account product. Safe+ is encrypted document storage that holds every deliverable from every Docsy appointment automatically. They are separate products. Safe+ is included free with every Docsy service for everyone." },
      { q: "Can I stack my Business+ discount with other promotions?", a: "Yes. Individual-tier (Solo / Pro / Elite) discounts stack with time-window promotions (Night Shift Seal, Midday Miles), HonorPass, and most other active promotions. Stacking rules are listed on the Promotions page — no asterisks, no surprises." },
      ...
      { q: "Is there an annual plan option?", a: "Yes. Annual plans are available for all individual tiers (Solo / Pro / Elite) at a 15% discount versus monthly pricing. You pay annually upfront. If you cancel 30+ days before your renewal date, you're eligible for a prorated refund for the unused period. Firm tier is invoiced monthly NET 30 by default; annual contracts available on request." },
      { q: "What hours do firm accounts get that individual tiers don't?", a: "Firm accounts include extended priority hours: 24/7 RON access, mobile signings 6 AM – Midnight (7 days), and a dedicated after-hours line. Individual tiers — Solo, Pro, Elite, and non-members — book within standard 9 AM – 9 PM hours." },
    ],
  },
  {
...
const guides = [
  ...
  { id: "how-to-read-your-invoice", icon: Receipt, title: "How to Read Your Docsy Invoice", summary: "Every line item explained.",
    content: [
      ...
      { heading: "Timing Add-Ons", body: "Rush surcharges (apostille, transcripts) — only if applicable, always disclosed at booking. Standard consumer hours are 9 AM – 9 PM, 7 days a week, with no after-hours surcharges. Extended priority hours are a Docsy Business+ Firm benefit." },
  ...
  { id: "docsy-safe-plus", icon: ScanLine, title: "How Docsy Safe+ Works", summary: "Encrypted storage for all Docsy appointment deliverables — included free.",
    content: [
      ...
      { heading: "Member benefits", body: "Active Docsy Business+ members get extended retention windows on stored files plus priority support on any Safe+-related issue. Membership is optional — Safe+ access itself is free for everyone." },
    ],
  },
