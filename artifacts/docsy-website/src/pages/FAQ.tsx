...
const guides = [
  ...
  { id: "docsy-safe-plus", icon: ScanLine, title: "How Docsy Safe+ Works", summary: "Encrypted storage for all Docsy appointment deliverables — included free.",
    content: [
      ...
      { heading: "Member benefits", body: "Active Docsy+ members get extended retention windows on stored files plus priority support on any vault-related issue. Membership is optional — Safe+ access itself is free for everyone." },
    ],
  },
