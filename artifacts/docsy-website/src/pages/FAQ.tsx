...
const faqs = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What's the difference between Docsy+ and Docsy Safe+ Vault?", a: "Docsy+ is a service membership with perks — priority access, free notarizations, after-hours access. Docsy Safe+ Vault is a document storage subscription — an encrypted vault that stores every deliverable from every Docsy appointment automatically. They are separate products. You can have one, both, or neither." },
...
const guides = [
  { id: "how-to-book-ron", icon: Video, title: "How to Book a Remote Online Notarization (RON)", summary: "Step-by-step guide to booking and completing your first RON appointment.",
    content: [
      ...
      { heading: "Step 5 — Receive your documents", body: "You'll receive a certified digital copy via email immediately. If you have Docsy Safe+ Vault, the document uploads automatically to your vault." },
    ],
  },
  ...
  { id: "docsy-safe-plus", icon: ScanLine, title: "How Docsy Safe+ Vault Works", summary: "Encrypted storage for all Docsy appointment deliverables — included free.",
    content: [
      { heading: "What it is", body: "Docsy Safe+ Vault is an encrypted file vault that automatically stores every deliverable from every Docsy appointment. No uploading required. Every RON notarization, every apostille, every loan signing, every electronic reporting session — transcripts included — stored automatically." },
      { heading: "Always included, always free", body: "Safe+ Vault is included free with every Docsy service for every client. No paid tiers, no trial countdown, no upsells. Confirm your booking and an account is created automatically — your files arrive there." },
      { heading: "Access", body: "Access your vault from any device, any time. Download or share documents and transcripts directly from your vault using the email you booked with." },
      { heading: "Member benefits", body: "Active Docsy+ members get extended retention windows on stored files plus priority support on any vault-related issue. Membership is optional — Safe+ Vault access itself is free for everyone." },
    ],
  },
