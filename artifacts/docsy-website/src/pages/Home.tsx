...
import homeImg from "@/assets/images/home-workspace-realism.png";
...
const NUM_CARDS = [
  ...
  {
    num: "06",
    title: "Encrypted document storage — included free with every service.",
                ...
                <div key={i} className="flex flex-col" style={{ backgroundColor: SLATE }}>
                  ...
                  <div className="flex-1">
                    {([15, 30, 60] as const).map(min => (
                      <div key={min} className="flex justify-between items-center px-6 py-3 border-b last:border-b-0" style={{ borderColor: DIV }}>
