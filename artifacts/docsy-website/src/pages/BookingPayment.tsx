...
const TERMS: Record<string, { heading: string; body: string[] }> = {
  ...
  court: {
    ...
    body: [
      ...
      "Appearance Only: If no transcript is ordered, an invoice for the appearance fee is generated on the day of the deposition and sent to the ordering party the same day. Payment is due within 14 days of the invoice date (Net-14).",
      "Appearance and Transcript: If a transcript is ordered, the appearance fee and transcript fee are combined into a single invoice. That invoice is generated when the transcript is complete and ready for delivery. The full balance — appearance and transcript together — is due within 14 days of the invoice date (Net-14). The transcript will not be released, delivered, or made accessible until payment is received in full. No exceptions.",
      "Multi-Counsel Billing: When multiple attorneys order copies from the same deposition, each attorney receives their own individual invoice generated when their copy is ready. Each invoice carries its own Net-14 window and is subject to the same hold-until-paid policy.",
