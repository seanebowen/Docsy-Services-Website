          ...
          <FadeIn delay={0} threshold={0.05}>
            <div className="mt-6" style={{ backgroundColor: DIV }}>
              <div className="px-8 py-6" style={{ backgroundColor: BG }}>
                ...
                <p className="text-xs font-bold" style={{ color: BLUE }}>★ Stacks with all promos. Verified members and Safe+ Vault holders have it saved and auto-applied — no code needed.</p>
              </div>
            </div>
          </FadeIn>
        </div>
